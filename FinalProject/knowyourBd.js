function ADtoBS() {
    ...
    function display_result(np_date) {
        ...
        var twitter_text = "<div style='height:50px; width:100px;'><a class='twitter-share-button' data-size='large' href='https://twitter.com/intent/tweet?text=My%20Nepali%20Birthday%20is%20on%20" + NepaliMonths[np_date[1]] + "%20" + np_date[2] + "%20" + np_date[0] + ".%20Find%20out%20your%20Nepali%20Birthday%20here:%20http://sites.bxmc.poly.edu/~krishnagaire/FinalProject/knowyourBD.html'><img src='images/fb-button.jpg' class='twitter-fb-btn'></a></div>";
        var fb_text = "<div style='height:50px; width:100px;'><a class='fb-xfbml-parse-ignore' target='_blank' href='http://sites.bxmc.poly.edu/~krishnagaire/FinalProject/knowyourBD.html'><img src='images/fb-button.jpg' class='twitter-fb-btn'></a></div>";
        console.log(fb_text);
